...
<section class="contact-us text-center py-3 py-sm-5">
  <div class="info py-2">
    ...
    <h2 class="">Комплексная поставка металлопроката в Краснодаре и крае.</h2>
...
<section class="about-us back-light-grey mt-3 mt-sm-5">
  ...
  <div class="row py-3 py-sm-4 container-xl mx-auto ">
    ...
    <div class="text-about col-sm-6">
      <p> Компания "МеталлМедиа" существует на Краснодарском рынке уже 5 лет, и за это время успела зарекомендовать себя в качестве надежного поставщика металлопроката. Мы занимаемся реализацией черного и оцинкованного металлопроката</p>
