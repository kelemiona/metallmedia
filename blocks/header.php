...
<head>
    ...
    <title>МеталлМедиа</title>
</head>
<body class="mx-auto">
    <header>
        <div class="head d-none d-sm-flex justify-content-sm-between">
            <div class="logo d-none d-sm-block py-auto pl-0 pl-sm-4">
        ...
        <div class="d-block d-sm-none for-small-device py-1 d-flex justify-content-between">
          <div>
            <img src="/img/logo-silver2.png" alt="logo" class="my-auto">
          </div>
          <div class="spinner" id="toggler">
